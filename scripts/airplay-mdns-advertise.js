#!/usr/bin/env node
/*
 * Phase 0 discovery-only mDNS/Bonjour advertisement PoC.
 * This script intentionally does not implement AirPlay session handling,
 * video receive/decrypt/decode/display, or iPhone input/control.
 */
